...
if(isset($_POST['btn-login'])) {
	...
	if (!$error) {
	 	$uploaddir = getcwd() . "/documentations/";
		...
		<div class="container">
			...
			<?php if($user != "") { ?>
							...
							<div class="col-md-3">
								<form action="#" method="get">
									<div class="input-group">
										<input class="form-control" id="system-search" name="q" placeholder="Cerca per" required autocomplete="off">
				...
				<?php if($user['granted'] == "Administrator") { ?>
					<div class="container" style="padding-top: 3%;">
						<div>
							<form method="post" action="<?php echo htmlspecialchars("http://samtinfo.ch/lpiarch/Carthafind/home.php#form-title"); ?>" autocomplete="off" id="insert" enctype="multipart/form-data">
								<div class="col-md-12">
									...
									<div class="form-group">
										<div class="input-group">
											...
											<input type="number" name="final_vote" class="form-control" onkeypress="return isNumberKey(event)"
									...
									<div class="form-group">
										<div class="input-group">
											...
											<input type="number" name="progress" class="form-control" onkeypress="return isNumberKey(event)"
